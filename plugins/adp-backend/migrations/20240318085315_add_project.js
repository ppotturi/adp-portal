...
exports.up = function (knex) {
  return knex.schema.createTable('delivery_project', table => {
    ...
    table
      ...
      .notNullable()
      .comment(
        'Delivery Project title in lower case and hyphens instead of spaces',
      );
    table.string('title').notNullable().comment('Delivery Project title');
    table.string('alias').nullable().comment('Alias of Delivery Project');
    table
      .string('description')
      .notNullable()
    ...
    table.string('url').nullable().comment('Delivery Project URL');
    table
      .string('ado_project')
      .nullable()
    ...
    table
      .string('updated_by')
      .notNullable()
      .comment('Username of the person who last updated the Delivery Project');
  });
};
